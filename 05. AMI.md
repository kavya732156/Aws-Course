...
2. ***Reserved Instances (RI)***
   ...
   ***Types:***
   1. Standard RI	, discount Up to 72% and Can change instance type ❌ No|
   2. Convertible RI, discount Up to 54% and Can change instance type ✅ Yes|
   3. Scheduled RI, no discount and no change on instance type
